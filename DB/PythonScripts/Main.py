...
if __name__ == "__main__":
    ...
    ans = raw_input("Do you want to add/update the Units table (Y or N)? ")
    if ans == 'Y':
    ...
    ans = raw_input("Do you want to add/update the stations table (Y or N)? ")
    if ans == 'Y':
    ...
    ans = raw_input("Do you want to add/update meteorolgy data  files (Y or N)? ")
    if ans == 'Y':
        fromY = input("From which year? (integer)")
        toY= input("To which year? (integer)")
        folder = "DataForDB"
    ...
    ans = raw_input("Do you want to add/update historic contaminants data  files (Y or N)? ")
    if ans == 'Y':
        fromY = input("From which year? (integer)")
        toY= input("To which year? (integer)")
        folder = "DataForDB"
